...
```bash
obsidian vault=second-brain create path="04 Data/YYYY/MM/YYYY.MM.DD-<name>.md" content="<full markdown content>" silent
```
...
```bash
obsidian vault=second-brain search query="<note-name>"
```
