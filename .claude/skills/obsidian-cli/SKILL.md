...
```bash
obsidian vault=second-brain create path="04 Data/2026/02/file.md" content="---
type: task
---
# My Note
Content here." silent
...
```bash
obsidian vault=second-brain read path="04 Data/2026/02/file.md"
```
...
obsidian vault=second-brain append path="file.md" content="New line"

# Appends directly to last character (no newline)
obsidian vault=second-brain append path="file.md" content=" inline text" inline
```
...
```bash
obsidian vault=second-brain move path="04 Data/old-name.md" to="04 Data/new-name.md"
```
...
```bash
obsidian vault=second-brain delete path="04 Data/file.md"
obsidian vault=second-brain delete path="04 Data/file.md" permanent
```
...
```bash
# Text (default type)
obsidian vault=second-brain property:set name=type value=person path="file.md"

# Number
obsidian vault=second-brain property:set name=confidence value=0.85 type=number path="file.md"

# List (pass JSON array)
obsidian vault=second-brain property:set name=tags value='["api","backend"]' type=list path="file.md"

# Checkbox
obsidian vault=second-brain property:set name=done value=true type=checkbox path="file.md"

# Date / Datetime
obsidian vault=second-brain property:set name=due value="2026-02-14" type=date path="file.md"
obsidian vault=second-brain property:set name=classified_at value="2026-02-13 14:00" type=datetime path="file.md"
```
...
```bash
obsidian vault=second-brain property:read name=type path="file.md"
```
...
```bash
obsidian vault=second-brain property:remove name=status path="file.md"
```
...
obsidian vault=second-brain search query="API deadline"

# JSON format (returns JSON array of paths)
obsidian vault=second-brain search query="sarah-chen" format=json
# Output: ["CLAUDE.md","04 Data/2026/02/2026.02.13-sarah-chen.md"]

# Scoped to a folder
obsidian vault=second-brain search query="sarah" path="04 Data" format=json

# Case-sensitive
obsidian vault=second-brain search query="API" case
```
...
```bash
obsidian vault=second-brain search:context query="sarah-chen" format=json
```
...
```bash
obsidian vault=second-brain daily:path
```
...
```bash
obsidian vault=second-brain rename path="04 Data/old-name.md" name="new-name"
```
...
```bash
obsidian vault=second-brain bases
```
...
```bash
obsidian vault=second-brain file path="04 Data/2026/02/file.md"
```
...
OUTPUT=$(obsidian vault=second-brain base:query path="file.base" format=json)
