...
```bash
obsidian vault=second-brain search query="YYYY-WNN-weekly-digest" path="04 Data" format=json
```
...
```bash
obsidian vault=second-brain search query="YYYY-MM-monthly-digest" path="04 Data" format=json
```
...
```bash
obsidian vault=second-brain search query="YYYY-yearly-digest" path="04 Data" format=json
```
