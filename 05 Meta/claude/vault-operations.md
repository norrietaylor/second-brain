...
└── 05 Meta/                   # System files
    ...
    └── scripts/               # Automation scripts
        ...
        ├── sb-ingest          # Import markdown files from ~/second-brain-inbox/ drop folder
...
Agents working in other projects can write session logs and captures to `~/second-brain-inbox/`
...
Key pattern: `obsidian vault=second-brain <command> [key=value...] [flags]`
...
- `sb-ingest` — Import markdown files from `~/second-brain-inbox/` drop folder. See `05 Meta/scripts/sb-ingest`
