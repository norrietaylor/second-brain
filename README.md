...
- **Configurable integrations** — GitHub, GitLab, Slack, Notion, Granola meeting sync, and Google Workspace (Gmail/Calendar/Gemini meeting minutes)
...
3. **Integrations** — which features to enable:
   ...
   - Google Workspace (Gmail triage, Calendar agenda, Gemini meeting-minutes ingestion — via Google MCPs)
