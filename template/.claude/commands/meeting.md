...
```bash
obsidian vault={{VAULT_NAME}} search query="<person-name>" path="04 Data" format=json
```
...
```bash
obsidian vault={{VAULT_NAME}} create path="<file_path>" content="<full markdown>" silent
```
